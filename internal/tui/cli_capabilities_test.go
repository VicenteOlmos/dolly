...
func TestFlagNamesDump(t *testing.T) {
	...
	want := []string{"dsn", "connection", "output", "no-transaction", "seed-file", "percent", "slow-connection", "chunk-size", "retry-max", "retry-base", "max-depth", "max-tables", "max-rows", "max-rows-per-table", "max-in-list-size", "include-table", "exclude-table", "include-table-file", "exclude-table-file", "json"}
