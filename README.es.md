...
```bash
curl -fsSL https://raw.githubusercontent.com/VicenteOlmos/dolly/main/install.sh | DOLLY_VERSION=0.3.1 sh
```
...
```powershell
$env:DOLLY_VERSION="0.3.1"; irm https://raw.githubusercontent.com/VicenteOlmos/dolly/main/install.ps1 | iex
```
...
| Fijar una versión | Defina `DOLLY_VERSION` (por ejemplo `0.3.1`) en el comando de instalación anterior. |
